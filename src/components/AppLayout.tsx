...
import { LayoutDashboard, Upload, BarChart3, Timer, LogOut, FileInput, Radio } from 'lucide-react';
...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="h-14 border-b border-border/50 flex items-center px-4 md:px-6 gap-3 shrink-0 glass sticky top-0 z-50">
